    ...
    <header>
        ...
        <nav id="menu">
            <ul>
                ...
                <li><a href="index.php?uc=visite&categorie=2&action=voirJeux"> Voir le catalogue de jeux </a></li>
                ...
                if (!$client) {
                    ...
                    echo '<li><a href="index.php?uc=compte&action=historique"> Commandes </a></li>';
